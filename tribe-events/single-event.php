...
<div id="tribe-events-content" class="tribe-events-single">
	...
	<script>
		window.addEventListener('load', () => {
			setTimeout(() => {
				document.querySelector("mpp-event-details").shadowRoot.querySelector("#detailsContainer").style.display = 'none'
			}, 100)
			...
			obs.observe(document.querySelector("mpp-event-details"), { childList: true, subtree: true })


			const elem = document.querySelector('mpp-event-details').shadowRoot

			console.log(document.querySelector('mpp-event-details').shadowRoot)

			if(!elem) return

			alert('elem cound. starting observer')
